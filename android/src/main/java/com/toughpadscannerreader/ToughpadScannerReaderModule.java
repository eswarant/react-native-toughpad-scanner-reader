...
public class ToughpadScannerReaderModule extends ReactContextBaseJavaModule implements ToughpadApiListener, BarcodeListener  {
  ...
  @ReactMethod
public void scanBarcode(Callback readCallBack){
  printDebugLog("scanBarcode");
...
public void printSelectedReaderDeviceInfo() {
  ...
  if(selectedReader!=null){
    ...
    printDebugLog("printSelectedReaderDeviceInfo" + " => HardwareTriggerAvailable : " + selectedReader.isHardwareTriggerAvailable());
  if (selectedReader.isHardwareTriggerAvailable()) {
    printDebugLog("printSelectedReaderDeviceInfo" + " => HardwareTriggerEnabled : " + selectedReader.isHardwareTriggerEnabled());
  }

  printDebugLog("printSelectedReaderDeviceInfo" + " => Selected reader is enabled/disabled : " + selectedReader.isEnabled());
  printDebugLog("printSelectedReaderDeviceInfo" + " => Selected Device Type : " + getDeviceTypeString(selectedReader));
